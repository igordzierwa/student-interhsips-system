<template>
  <div class="full">
    <el-row >
      <el-col>
        <h4>
          Akceptacja praktyki dodanej przez studenta
        </h4>
    ...
    <el-row >
      <el-col>
        ...
        >
          ...
          <el-form-item label="Uwagi:" prop="review">
            <el-input
                    type="textarea"
                    :rows="4"
                    maxlength="500"
...
export default {
  ...
  data() {
    return {
      userLogged: false,
      componentName: "acceptinternshipcs",
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      this.axios({
        method: "POST",
        url: this.api + "/accept-internship/company-supervisor",
        data: {
